                                            ...
                                            <tr>
                                                <td align="center" class="es-m-txt-c"
                                                    style="padding:0;Margin:0;padding-bottom:10px"><h1
                                                        ...
                                                        L'authentification OTP à été activé !</h1></td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                    ...
                                                    <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                        Nos systèmes nous indique que vous avez souhaité
                                                        activé la double authentification OTP sur votre
                                                        compte.<br>​<br>Un code vous sera envoyer sur votre
                                                        adresse mail <strong>{{ $user->email }}</strong> à chaque
                                                        fois que nécessaire afin de garantir une sécurité
                                                        supplémentaire à votre compte.</p></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
